  ...
  return <div className="w-full overflow-hidden border rounded-lg shadow-sm bg-white animate-slideUp">
      <div className="overflow-x-auto">
        <table className="w-full">
          ...
          <tbody>
            {members.map(member => <tr key={member.id} className="border-b hover:bg-gray-50 transition-colors cursor-pointer">
                <td className="px-4 py-3 text-sm" onClick={() => setSelectedMember(member)}>
                  <div>
                ...
                <td className="px-4 py-3" onClick={() => setSelectedMember(member)}>
